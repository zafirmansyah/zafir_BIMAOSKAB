<div class="nav-tabs-custom">
   <ul class="nav nav-tabs">
      <li class="active"><a href="#tab_1" data-toggle="tab" aria-expanded="false">Daftar Gudang</a></li>
      <li class=""><a href="#tab_2" data-toggle="tab" aria-expanded="true">Gudang</a></li>
   </ul>
...
<script type="text/javascript">
   ...
   bos.mstgudang.cmdedit 		= function(kode){
		bjs.ajax(this.url + '/editing', 'kode=' + kode);
	}

	bos.mstgudang.cmddelete 	= function(kode){
   ...
   bos.mstgudang.cmdsave       = bos.mstgudang.obj.find("#cmdsave") ;
	bos.mstgudang.initfunc	   = function(){
      this.obj.find('a[data-toggle="tab"]').on('shown.bs.tab', function (e) {
         if($(e.target).parent().index() == 0){//load grid
            bos.mstgudang.grid1_reloaddata() ;
         }else{//focus
            bos.mstgudang.obj.find("#nik").focus() ;
         }
      });
		...
		this.obj.find('form').on("submit", function(e){
         ...
         if( bjs.isvalidform(this) ){
				bjs.ajax( bos.mstgudang.base_url + '/saving', bjs.getdataform(this) , bos.mstgudang.cmdsave) ;
			}
		}) ;
	}
